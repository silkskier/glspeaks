...
8. [Matthew J. Graham at all - A comparison of period finding algorithms](https://arxiv.org/pdf/1307.2209.pdf)
9. [Deep Forward Thinking Random Forest ensemble learning method](https://arxiv.org/abs/1705.07366)
10. [randomForest Go machine learning library](https://github.com/malaschitz/randomForest)
11. [GoLearn machine learning library](https://github.com/sjwhitworth/golearn)
12. [Friedman, J. H. (1984) A variable span scatterplot smoother](https://www.slac.stanford.edu/pubs/slacpubs/3250/slac-pub-3477.pdf)
13. [supersmoother Python package](https://github.com/jakevdp/supersmoother)
14. [VkFFT library](https://github.com/DTolm/VkFFT)
