 ...
 * Date: 2018-10-01
 */
void gls_p_par(const double* const t, const float* const y, const float* const e_y, const unsigned int n, const unsigned int nk, const float fstep,const float* const f,float* p, float* a) { //
